...
export default function LoyaltyPage() {
    ...
    const noOptionsEnabled = !settings.option_card_enabled && !settings.option_points_enabled && !settings.option_visits_enabled;
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 mt-1">Manage loyalty cards, points, and rewards</p>
                </div>
